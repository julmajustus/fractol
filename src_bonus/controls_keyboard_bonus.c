...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   controls_keyboard_bonus.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: jmakkone <jmakkone@student.hive.fi>        +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/11 16:17:18 by jmakkone          #+#    #+#             */
/*   Updated: 2024/07/25 08:43:27 by jmakkone         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	keys_multibrot_controls(mlx_key_data_t key, t_fractol *f)
{
	if (key.key == MLX_KEY_E && key.action == MLX_PRESS)
		f->d++;
	else if (key.key == MLX_KEY_Q && key.action == MLX_PRESS)
	{
		f->d--;
		if (f->d < 2)
			f->d++;
